...
Follow.prototype.validate = async function(action){
     ...
     if(followedAccount){
          ...
          this.errors.push("You cannot a user that does not exist.")
     }
     ...
     if(action == "delete"){
          if(!doesFollowAlreadyExist){
               this.errors.push("You are not following this person.")
          }
     }
     ...
     return new Promise(async (resolve, reject) => {
          try{
               ...
               followers = followers.map(function(follower){
                    ...
                    return {
                         username: follower.username, avatar: user.avatar
                    }
               })
               resolve(followers)
          }
     ...
     return new Promise(async (resolve, reject) => {
          try{
               ...
               following = following.map(function(following){
                    ...
                    return {
                         username: following.username, avatar: user.avatar
                    }
               })
               resolve(following)
          }
